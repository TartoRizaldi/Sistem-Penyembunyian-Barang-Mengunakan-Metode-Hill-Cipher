  ...
  <div class="row">
    <div class="col-lg-4">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form action="<?= base_url('laporanbarangkeluar/filter') ?>" method="POST" target="_blank">
    ...
    <div class="col-lg-4">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form action="<?= base_url('laporanbarangkeluar/filter') ?>" method="POST" target='_blank' class="">
