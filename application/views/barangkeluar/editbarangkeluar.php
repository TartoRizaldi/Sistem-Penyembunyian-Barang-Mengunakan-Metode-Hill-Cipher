<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="id_barangkeluar" value="<?= $barang_keluar['id_barangkeluar']; ?>" readonly>
            ...
            <div class="col-sm-5">
                <select class="form-control" id="id_barang" name="id_barang">
                    <?php foreach ($barang as $brg) : ?>
                        <?php if($brg == $barang_keluar['id_barang']) : ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="date" class="form-control" name="tgl_keluar" value="<?= $barang_keluar['tgl_keluar']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="stok_keluar" value="<?= $barang_keluar['stok_keluar']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="total" value="<?= $barang_keluar['total']; ?>">
